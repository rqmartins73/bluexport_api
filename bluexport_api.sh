...
help() {
	...
	echoscreen ""
	echoscreen "=== General ==="
	echoscreen "Changing secret file:       bluexport_api.sh -chscrt bluexscrt_file_name"
	echoscreen "  (use full path, e.g. /home/user/bluexscrt_new.json)"
	echoscreen "  (will also ask/update log file path)"
	...
	echoscreen "Capture all volumes:"
	echoscreen "  bluexport_api.sh -a VSI_NAME IMAGE_NAME both|image-catalog|cloud-storage"
	echoscreen "  hourly|daily|weekly|monthly|single"
	echoscreen "Capture excluding volumes:"
	echoscreen "  bluexport_api.sh -x EXCLUDE_NAME VSI_NAME IMAGE_NAME"
	echoscreen "  both|image-catalog|cloud-storage hourly|daily|weekly|monthly|single"
	...
	echoscreen "Create snapshot:"
	echoscreen "  bluexport_api.sh -snapcr VSI_NAME SNAPSHOT_NAME 0|\"DESCRIPTION\""
	echoscreen "    0|\"VOL1,VOL2,...\""
	echoscreen "  Use 0 to omit DESCRIPTION or VOLUMES (0 = all volumes)."
	echoscreen "Update snapshot:"
	echoscreen "  bluexport_api.sh -snapupd SNAPSHOT_NAME 0|NEW_SNAPSHOT_NAME 0|\"DESCRIPTION\""
	...
	echoscreen "  bluexport_api.sh -imgimport IMGNAME BUCKET BUCKET_REGION WORKSPACE IMGNAME_WS"
	echoscreen "    STORAGE_TYPE CURRACCOUNT|OTHERACCOUNT [HMAC_JSON_FILE]"
	echoscreen ""
	...
	echoscreen "  bluexport_api.sh -imgexport IMGNAME BUCKET BUCKET_REGION"
	echoscreen "    CURRACCOUNT|OTHERACCOUNT [HMAC_JSON_FILE]"
	echoscreen ""
	echoscreen "  BUCKET_REGION:"
	...
	echoscreen "List objects from a bucket: bluexport_api.sh -bucketlsobjs"
	echoscreen "  (interactive - guided selection)"
	echoscreen "Delete object from a bucket: bluexport_api.sh -bucketdelobj"
	echoscreen "  (interactive - guided selection)"
	echoscreen "Restore archived object:"
	echoscreen "  bluexport_api.sh -restorefromarchive BUCKET OBJECT [DAYS] [ARCHIVE_TYPE]"
	...
	echoscreen "Delete volume clone:"
	echoscreen "  bluexport_api.sh -vclonedel REQUEST_CLONE_NAME 0|delete_volumes"
	...
	echoscreen "Change volume tier (by name):"
	echoscreen "  bluexport_api.sh -vchtier VSI_NAME VOLUMES_NAME TIER_TO_CHANGE_TO"
	echoscreen "Change volume tier (all VSI volumes):"
	echoscreen "  bluexport_api.sh -insvchtier VSI_NAME TIER_TO_CHANGE_TO"
	echoscreen ""
	...
	echoscreen "  bluexport_api.sh -grscancelfailover SOURCE_VSI VG_NAME NO_DETACH|DETACH"
	...
	echoscreen ""
	echoscreen "  SOURCE_VSI / TARGET_VSI:"
	echoscreen "    Logical PowerVS instance names as defined in your JSON."
	echoscreen "  VG_NAME:"
	echoscreen "    Name for the Volume Group to create on the source workspace."
	echoscreen "  SOURCE_VOLUMES_NAME:"
	echoscreen "    Common name/prefix to identify source VSI volumes (e.g. IBMiGRS)."
	echoscreen ""
	...
	echoscreen ""
	echoscreen "VSI Operations:"
	echoscreen "  bluexport_api.sh -vsioper VSI_NAME BOOT_MODE OPERATING_MODE"
	...
	echoscreen ""
	echoscreen "Attach volumes by common name:"
	echoscreen "  bluexport_api.sh -attachvolumes VOLUMES_COMMON_NAME VSI_NAME"
	echoscreen "      Attach all volumes in the workspace whose name contains"
	...
	echoscreen "=== Examples ==="
	echoscreen "Capture all volumes:"
	echoscreen "  bluexport_api.sh -a vsiprd vsiprd_img image-catalog daily"
	echoscreen "Capture excluding ASP2_:"
	echoscreen "  bluexport_api.sh -x ASP2_ vsiprd vsiprd_img both monthly"
	echoscreen "Capture excluding ASP2_ & iASPname:"
	echoscreen '  bluexport_api.sh -x "ASP2_ iASPname" vsiprd vsiprd_img both monthly'
	echoscreen ""
	echoscreen "Test mode (no capture):"
	echoscreen "  bluexport_api.sh -ta vsiprd vsiprd_img image-catalog daily"
	echoscreen "Test mode (no capture):"
	echoscreen "  bluexport_api.sh -tx ASP2_ vsiprd vsiprd_img both single"
	echoscreen ""
